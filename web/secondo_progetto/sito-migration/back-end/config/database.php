...
require_once __DIR__ . "/../core/dbIntegrityGuard.php";
...
try {
    runDatabaseIntegrityGuard($conn);
} catch (Throwable $exception) {
    error_log("Database integrity guard skipped: " . $exception->getMessage());
}
